...
#    echo -e "\n/**\n * @param ${MODULE_NAME}${VERB_FOR}Request\n * @return ${MODULE_NAME}${VERB_FOR}Response\n\t */" >> $MODULE_PATH
    echo "fun ${VERB_FOR,,}(req: ${MODULE_NAME}${VERB_FOR}Request) : ${MODULE_NAME}${VERB_FOR}Response = ${MODULE_NAME}${VERB_FOR}Response()" >> $MODULE_PATH
...
#    echo -e "/**\n * @param [id] Id\n * @param [__comment] Internal Comment\n */" >> $MODEL_PATH
    ...
    # MODULES
#    echo -e "\n/**\n * @param ${MODULE_NAME}${VERB_FOR}Request\n * @return ${MODULE_NAME}${VERB_FOR}Response\n\t */" >> $MODULE_PATH
    echo "fun ${VERB_FOR,,}(req: ${MODULE_NAME}${VERB_FOR}Request) : ${MODULE_NAME}${VERB_FOR}Response = ${MODULE_NAME}${VERB_FOR}Response(id=req.id)" >> $MODULE_PATH
